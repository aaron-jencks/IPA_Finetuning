#!/bin/bash
#SBATCH --job-name=gpt2_finetune_eng_spa_sentiment
...
config_file="config/finetune-eng-spa-sentiment-normal.json"
if [[ "$model_type" == "ipa" ]]; then config_file="config/finetune-eng-spa-sentiment-ipa.json"; fi
